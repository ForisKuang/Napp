...
public class AuthenticationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    token = GoogleAuthUtil.getToken(AuthenticationActivity.this, Plus.AccountApi.getAccountName(mGoogleApiClient), scope);
